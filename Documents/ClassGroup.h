...
<table>
    ...
    <tr>                            <td>SDX::ThreadLoad         <td>リソースの非同期読み込み設定関数群</td></tr>
    <tr style="background:#ccccff"> <td>画像処理</td><td> </td></tr>
    <tr>                            <td>SDX::Blend              <td>Image同士の合成処理を行う関数群</td></tr>
    <tr>                            <td>SDX::BlendBlt           <td>イメージを合成して作成</td></tr>
    <tr>                            <td>SDX::Filter             <td>Imageにフィルター処理を行う関数群</td></tr>
    ...
    <tr>                            <td>SDX::Movie              <td>動画を表すクラス</td></tr>
    <tr>                            <td>SDX::MovieImage         <td>Imageクラスの動画版</td></tr>
    ...
    <tr>                            <td>SDX::Shape              <td>位置情報を持つ図形の抽象クラス</td></tr>
    ...
    <tr>                            <td>SDX::Sprite             <td>2Dモデルに貼り付けるスプライトを表す抽象クラス</td></tr>
    ...
    <tr>                            <td>SDX::ModelMove          <td>Modelの移動を移譲するクラス</td></tr>    
    ...
    <tr>                            <td>SDX::Pool               <td>メモリプールを表すクラス[未実装]</td></tr>
    <tr>                            <td>SDX::Allocater          <td>自作メモリアロケータ[未実装]</td></tr>
    <tr>                            <td>SDX::Rand               <td>乱数生成関数群</td></tr>
    <tr>                            <td>SDX::Time               <td>時間と日付を取得する関数群</td></tr>
    <tr>                            <td>SDX::ISpeed             <td>変化する数値を表す抽象クラス</td></tr>
    <tr>                            <td>SDX::IModule            <td>Update可能なモジュールのインターフェース</td></tr>
    <tr>                            <td>SDX::PartTimeModule     <td>ラムダ式で実行条件を追加可能なモジュール</td></tr>
    <tr>                            <td>SDX::FuncModule         <td>関数オブジェクトをモジュール化するクラス</td></tr>
</table>
