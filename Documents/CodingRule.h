...
例えば、「yes/noを表す変数はintで無くboolを使おう｣とか｢NULLじゃなくnullptr使おう｣とかを常識的な事は規約に書きません。\n
無駄に規約が長くなって読むのが面倒になる上、大量にある常識的な事を書くのは無理なので抜けが出るため無意味です\n
\n
...
\n
<B>前置インクリメント</B>\n
デバッグビルドもあるので前置インクリメントを使う\n
そもそも最適化されてもされなくても差は殆ど無いとは思いますが、一応\n
\n
<B>float型</B>\n
基本的に使わず、doubleに統一する\n
\n
