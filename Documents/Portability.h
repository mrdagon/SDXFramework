...
例えば特定のコンパイラの拡張文法や特定OSのAPIを使っている場合、移植性が下がります\n
\n
<HR>
<B>文字エンコーディング</B>\n
...
表示が変わるので複数のOSに対応する場合、OS標準フォントは使うべきではありません\n
<HR>
<B>DXLIB版とSDL版</B>\n
...
<HR>
<B>アプリ内課金や広告、BlueTooth通信、twwiter連携等</B>\n
今のところSDXで実装していないので、自前で実装する必要があります。\n
*/