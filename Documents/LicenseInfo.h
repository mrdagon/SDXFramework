...
\n
[ソースコードの公開]\n
　ソースコードを入手可能にする必要があります\n
ソフトと一緒に配布する、Github等で公開する、問い合わせが来たらメールで送る等、公開方法は問いません\n
SDXFrameworkの部分のコードは一緒に配布するか、あるいはどこで入手可能かを示す必要があります\n
\n
[同じライセンスの適用]\n
　公開したソースコードにもAGPL Ver3を適用する必要があります\n
\n
[再配布の許可]\n
...
以下の表記をソフトウェアと一緒に配布するドキュメント、あるいはソフトウェア内のクレジットで明示して下さい\n
\n
<B>ライセンス表記</B><BR>
