...
\n
Ａ.\n
　以前に公開していたverのライセンスはそのままなので、旧バージョンはzlibライセンスで利用する事が出来ます。\n
ややこしいので旧verの配布はしていませんが、DXLib版を使っていた等の理由で旧Verが欲しい場合は連絡して下さい\n
\n
<HR>
...
\n
<HR>
Ｑ.ライセンス変更をまた変更する可能性はある？\n
\n
Ａ.\n
　あまり変更したくありませんが、AGPL ver3ではAppstore等で配布出来ないため、特定ハードだけデュアルライセンスにするとかは一応あり得ます。\n
\n
<HR>
Ｑ.破壊的変更って何？\n
\n
...
\n
Ａ.\n
機能はDXLibの方がSDLより豊富ですが、プラットフォーム対応の差でSDLに専念する事にしました。\n
<HR>
