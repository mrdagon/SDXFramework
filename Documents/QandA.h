...
\n
　それとSDL2.0はzlibなんだけど、SDL2.0で必要なsmpegやlibmodがLGPLなので、それらと静的にリンクするAndroid版だと\n
結局コードを公開する必要があり、緩いライセンスにしてもGPLと違いがなさそうってのもあります.\n
(もしかするとSDLの開発者が個別に許可を取っていて全体でzlibな可能性もあるかもだけど)\n
<HR>
Ｑ.どういう人向け？\n
\n
Ａ.\n
　日本語ドキュメントがあるライブラリが必要で、デスクトップ環境中心の2Dゲームを作っており、Androidでも動くとなお良くGPLでも構わない人向けです。\n
あるいはSDLをC++と組み合わせて使おうと思ったけど面倒そうに思えた人にはお勧めです。
\n
　わりとニッチなのもあって利用者数は伸びておらず、改変したいゲームが当ライブラリを利用している場合を除くと、機能的な面でSDXを強く薦める理由は特にありません。\n
例えば3D機能、広告機能、SNS機能、動画機能、物理演算等が欲しい場合は他の開発環境使った方が楽だと思います。\n
\n
<HR>
...
\n
<HR>
Ｑ.AGPLのコードを読んでアルゴリズムや設計を勉強した後、一から似たようなコードを描いた場合AGPLで公開する必要はありますか？\n
SDXの実装を参考にしてSDL2.0を使って非GPLでソフトを配るとかはOK？\n
\n
Ａ.\n
　アルゴリズムや設計、デザインパターン等は著作権で保護されないので、GPLのコードを読んでプログラミングを勉強したからといってGPLで公開する必要はありません。\n
コードを読んで記憶を頼りにほぼ同じソフトを作るとか、コードを横に並べて変数名やら細部を微妙に変えたコードに書き直すとかする場合はGPLにする必要があります。\n
...
\n
Ａ.\n
　ライブラリに何らかの修正を加えた場合は、変更した箇所のコードを配布するか必要があります。\n
