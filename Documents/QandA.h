...
\n
　当ライブラリを利用しているゲームを改変したい場合を除くと、機能的な面でSDXを強く薦める理由は特にありません。\n
例えば3D機能、広告機能、SNS機能、動画機能、物理演算等が欲しい場合や緩いライセンスのが良い場合は他の開発環境使った方が楽だと思います。\n
\n
<HR>
...
\n
Ａ.\n
　ライセンス違反を発見した場合、是正を要求しますが、よほどの事が無い限り訴訟とかはありません。\n
