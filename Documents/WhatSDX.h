...
(※技術を独占したい、ソフトウェアを売りたい、自分のソフトを少しもいじって欲しく無い等の理由で公開しない場合もあります)\n
ライセンスについては、経済的な視点、技術的な視点、コミュニティ的な視点で考える事が出来ます。\n
\n
[1.緩いオープンなライセンス]\n
例えばApache LicenseやMITライセンスは派生物に対してライセンス表記や特許のクロスライセンスしか求めません。\n
そのためライブラリを利用したコードを公開するかどうかは任意になります。\n
...
\n
また自分しか持っていない独自技術がある場合でも公開した方が有利な場合がもあります。\n
...
\n
　さらに後進の育成にも繋がります。\n
　色んな所の質問掲示板で｢こういうゲームを作りたいが参考になるコードはないか？｣と言った質問は結構見かけるのでコードの需要はあるはずです\n
...
どれだけの人に届くか分からないのに時間を使ってドキュメントの整備やら宣伝やらしようと言うのは辛い物があります。\n
