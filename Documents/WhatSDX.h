...
OSSに参加したいけど英語はあまり得意では無い人に対してアピール出来るため、開発者が集まりやすくなるはずです\n
また、この程度の規模のライブラリなら主要コミッタは一人でも大体間に合うぐらいなので日本語圏の人限定でアピールする方が楽です\n
\n
二つ目は開発効率の都合です。\n
日本語の方が得意なので英語主体で開発を進めるのは効率が悪すぎます\n
特に仮引数は日本語にして、リファレンスを見る回数を減らせるようにした方が使いやすいし、開発が楽です。\n
\n
...
\n
さらに後進の育成にも繋がります。教育機会均等の考えから言ってもコードの公開ぐらいはした方が良いと思います\n
解説サイトを作るのは相当な手間ですが、コード公開はそこまで手間ではありません\n
\n
[3.コミュニティ的な理由]\n
個人レベルでソースコードを公開しても、そういう事をしている人が少ないため、他開発者やユーザーから認知されにくいです。\n
