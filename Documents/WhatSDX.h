...
\n
　しかしながらゲームの場合、イラストやBGMやシナリオを別のライセンスで配布すれば、ソフトウェア単体ではほぼ動作しないので、\n
商業上の問題が抑えられます。またゲームとサントラの値段があまり変わらないと言った事があるように、ゲームの価格に対する影響も殆どないと思われます。\n
\n
...
しかしながらライブラリがコピーレフトな場合の方がその効果は大きくなります。\n
\n
...
解説サイトを作るのは相当な手間ですが、コード公開はそこまで手間ではありませんし、教育機会の均等や公開ぐらいした方が良いのではないかと思います\n
　コードの公開は道徳的でもあります。\n
\n
　このような理由でライブラリをAGPLにしています。\n
\n
　今まで、ゲームを一から実装しようとして多くの人が開発途中で挫折してきました。\n
ゲームを作るのに個人で一から実装する必要はありません、既にあるコードを利用出来る方が楽に決まっています。\n
何万行ものコードを個人で実装しなければいけない状況は正しいのでしょうか？\n
\n
　開発者同士が協力したり支援する事は決して難しい事でも面倒な事でもありません、コードを公開するだけで良いのです\n
\n
